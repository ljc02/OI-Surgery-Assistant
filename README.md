...
| 目的       | 关键项                        | 建议范围     | 说明                                    |
|------------|-------------------------------|--------------|-----------------------------------------|
| 稳定风格   | num_inference_steps            | 30–60        | 步数越大细节越多但速度更慢              |
| 降低漂移   | seed                           | 固定数       | 便于复现实验                            |
| 时间一致性 | guidance_scale                 | 3–6          | 过大可能使动作失真                      |
|            | consistency / temporal_weight  | 0.6–0.9      | 越大越稳但易拖影                        |
| 面部质量   | face_restore / GFPGAN          | on           | 人像场景建议开启                        |
| 分辨率     | width / height                 | 512–768      | 先小后大，注意显存                      |
